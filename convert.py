...
data_dir = '/research/pheng5/jzwang/code2/PANet/data/coco'

def cocoSegmentationToPngDemo(dataDir= data_dir, dataTypeAnn='val2017', dataTypeRes='examples', \
    ...
    if isAnnotation:
        ...
        resPath = '%s/results/instances_%s_results.json' % (dataDir, dataTypeRes)
